...
class InputFile extends buildPluginModule.InputFile {
   ...
   * file.
   * @param {Function} lazyFinalizer Optionally supply a function that can
   *                   be called to obtain any remaining options
   *                   properties that may be expensive to compute, and
   *                   thus should only be computed if/when we are sure
   *                   this CSS will be used by the application.
   * @memberOf InputFile
   * @instance
   */
   ...
   *                   properties that may be expensive to compute, and
   *                   thus should only be computed if/when we are sure
   *                   this JavaScript will be used by the application.
   * @memberOf InputFile
   * @instance
   */
   ...
   *                   properties that may be expensive to compute, and
   *                   thus should only be computed if/when we are sure
   *                   this asset will be used by the application.
   * @memberOf InputFile
   * @instance
   */
   ...
   *                   properties that may be expensive to compute, and
   *                   thus should only be computed if/when we are sure
   *                   this HTML will be used by the application.
   * @memberOf InputFile
   * @instance
   */
  addHtml(options) {
